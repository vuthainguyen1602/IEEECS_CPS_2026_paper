...
\author{\IEEEauthorblockN{Nguyễn Vũ Thái\IEEEauthorrefmark{1}, Bùi Văn Dũng\IEEEauthorrefmark{2}\IEEEauthorrefmark{3}}
	\IEEEauthorblockA{\IEEEauthorrefmark{1}Trường Đại học Giao thông Vận tải, Phân hiệu tại TP. Hồ Chí Minh}
	\IEEEauthorblockA{\IEEEauthorrefmark{2}Đại học Quốc gia TP. Hồ Chí Minh}
	\IEEEauthorblockA{\IEEEauthorrefmark{3}Trường Đại học Công nghệ Thông tin}
	\IEEEauthorblockA{Email: nvthai@utc2.edu.vn, dungbv.17@grad.uit.edu.vn}
}
