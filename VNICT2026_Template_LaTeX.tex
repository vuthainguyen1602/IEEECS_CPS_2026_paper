...
\title{Phát hiện Xâm nhập cho Điện toán Biên bằng Ensemble Stacking kết hợp SMOTEENN và Chưng cất Tri thức}
...
\begin{IEEEkeywords}
Intrusion Detection System, Edge Computing, Knowledge Distillation, Ensemble Learning, Extreme Data Imbalance, SMOTEENN, CICIDS2017.
\end{IEEEkeywords}
